        ...
        <View style={style.container}>
            ...
            <View style={style.check_area}>
                <BouncyCheckbox
                    ...
                    disableText={true}
                />
                <Text style={style.check_txt}>Deseja receber as últimas atualizações do nosso aplicativo? Marque esta caixinha para se manter informado(a) sobre novos recursos e melhorias</Text>
            </View>
        </View>
    )
}